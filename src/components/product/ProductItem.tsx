      ...
      <div className="p-4">
        ...
        <div className="flex flex-col">
          ...
          <Link
            ...
            className="w-full text-center bg-gradient-to-r from-indigo-500 to-indigo-600 text-white py-2 rounded-full text-sm font-bold hover:brightness-120 transition-all"
          >
            GRAB IT NOW!
          </Link>
